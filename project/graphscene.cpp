...
void SimpleGraphScene::drawGraph(Graph g){
    nodes.resize(g.number_of_nodes());
    //leda::list<leda::node> fixed;
    leda::node_array<double> xpos;
    leda::node_array<double> ypos;
    //leda::SPRING_EMBEDDING(g,fixed,xpos,ypos,-50.0,50.0,-50.0,50.0);
    //leda::SPRING_EMBEDDING(g,xpos,ypos,-50.0,50.0,-50.0,50.0,250);
    ...
    forall_nodes(v,g) {
        ...
        QGraphicsEllipseItem* el = this->addEllipse(xpos[v],ypos[v],10,10,blackPen,redBrush);
